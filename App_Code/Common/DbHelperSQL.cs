...
public abstract class DbHelperSQL
{
    ...
    public static string connectionString = String.Format(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString,
        AesEncryption.Decrypt(ConfigurationManager.AppSettings["DBConnectionIP"].ToString()),
        AesEncryption.Decrypt(ConfigurationManager.AppSettings["DBConnectionUserID"]),
        AesEncryption.Decrypt(ConfigurationManager.AppSettings["DBConnectionPassword"]));
    public DbHelperSQL() { }
